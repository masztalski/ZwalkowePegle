...
public class StationListAdapter extends ArrayAdapter<Station> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(s.getDischargeRecords().isEmpty()){
            ...
            String przeplyw = Double.toString(s.getDischargeRecords().get(0).getValue()) + " m<sup>3</sup>/s";
...
//        if(s.getDolnaGranicaPoziomu() != -1 && s.getDolnaGranicaPoziomu() < s.getStatus().getCurrentValue()){
